...
* __Free__ to use
* __Extensible__
    * Over 7300 user contributed add-on packages currently on [CRAN](https://cran.r-project.org/) (The Comprehensive R Archive Network)
...
Slides and material are available at
 [http://hofmann.github.io/rwrks/summerschool](http://hofmann.github.io/rwrks/summerschool).
...
- [Download](knitr/0-getting-started.Rmd), save, and open the document which generates these slides in RStudio (you can do that with this R code):

```{r, eval = FALSE}
curl::curl_download(
  "https://raw.githubusercontent.com/hofmann/rwrks/gh-pages/01-Introduction-to-R/knitr/0-getting-started.Rmd",
...
```{r, eval = FALSE}
curl::curl_download(
  "https://raw.githubusercontent.com/hofmann/rwrks/gh-pages/01-Introduction-to-R/code/0-getting-started.R",
  "0-getting-started.R"
)
