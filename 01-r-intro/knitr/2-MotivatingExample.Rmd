...
shed <- read_csv("../data/daily_shedding.csv")
  #read_csv("http://heike.github.io/rwrks/01-r-intro/data/daily_shedding.csv")
```
...
shed %>% filter(time_point != 0) %>% ggplot() + 
  geom_boxplot( aes(treatment, daily_shedding, fill = treatment), position = position_dodge2(preserve = 'total'))  + 
